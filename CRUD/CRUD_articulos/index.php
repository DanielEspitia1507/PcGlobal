...
?>
    ...
    <div class="mx-4 2xl:mx-44 mt-8 mb-8 text-white"><a class="bg-teal-500 p-2.5 rounded-md hover:text-stone-100 hover:bg-teal-600 hover:shadow-lg" href="agregar_producto.php"><i class="fas fa-plus"></i> Agregar Empleado</a></div>
    <div>
